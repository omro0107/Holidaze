    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
        ...
        <div>
          ...
          <p className="text-xl text-text font-body">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
        ...
        <div className="md:order-1">
          ...
          <div className="space-y-4 text-text font-body">
            <p>
      ...
      {/* Why Book Section */}
      <div className="mb-24">
        <h2 className="text-4xl font-heading font-bold text-text text-center mb-16">
